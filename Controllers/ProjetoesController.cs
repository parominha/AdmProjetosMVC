...
namespace AdmProjetosMVC.Controllers
{
    public class ProjetoesController : Controller
    {
        ...
        public ProjetoesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataEntrega,DataCadastro,Ativo")] Projeto projeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DataEntrega,DataCadastro,Ativo")] Projeto projeto)
        {
            if (id != projeto.Id)
            {
                return NotFound();
